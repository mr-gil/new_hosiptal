...
import com.sdu.edu.adapter.MergepatientAdapter;
import com.sdu.edu.adapter.UpdatepatientAdapter;

import com.sdu.edu.callback.SizeCallBackForMenu;
import com.sdu.edu.control.Connectgetallpatients;
...
public class MergePatientActivity extends Activity {
	// delete patient
	//@author sdusjy
	...
	private MergepatientAdapter upadater;
	...
	private void init() {
		...
		pd_loging = new ProgressDialog(MergePatientActivity.this);
	...
	private class Adddoctor implements Runnable {
		public void run() {
			// 获得所有列表
			Connectgetallpatients ctt = new Connectgetallpatients("1");
			...
			public void handleMessage(Message msg) {
				...
				if (msg.what == 0) {
					...
					Log.i("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
							"" + listItems.toString());
					upadater = new MergepatientAdapter(MergePatientActivity.this,
							R.layout.all_patient_list_item, listItems);
