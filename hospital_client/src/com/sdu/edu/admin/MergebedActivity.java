...
import com.sdu.edu.adapter.MergebedAdapter;
...
public class MergebedActivity extends Activity {
	// 第一个主界面
	private MenuHorizontalScrollView scrollView;
	private ListView menuList;
	private ListView doctorList;

	private MergebedAdapter upadater;
	private List<String> listItems;
	private View up_bedPage;
...
//				WindowManager.LayoutParams.FLAG_FULLSCREEN);
		...
		this.up_bedPage = inflater.inflate(R.layout.activity_update_doctor,
				null);
		this.title = (TextView) this.up_bedPage
				.findViewById(R.id.topbar_title);
		title.setText("Delete Doctor");
		title.setGravity(Gravity.RIGHT);
		title.setTextSize(10.0f);
		this.menuBtn = (Button) this.up_bedPage.findViewById(R.id.menuBtn);

		this.menuBtn.setOnClickListener(onClickListener);

		View leftView = new View(this);
		leftView.setBackgroundColor(Color.TRANSPARENT);
		final View[] children = new View[] { leftView, up_bedPage };
	...
	private void init() {
		...
		pd_loging = new ProgressDialog(MergebedActivity.this);
			...
			public void handleMessage(Message msg) {
				...
				if (msg.what == 0) {
					...
					Log.i("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
							"" + listItems.toString());
					upadater = new MergebedAdapter(MergebedActivity.this,
							R.layout.all_bed_list, listItems);
					doctorList = (ListView)up_bedPage
