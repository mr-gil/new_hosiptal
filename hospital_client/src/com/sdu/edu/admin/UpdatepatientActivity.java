...
public class UpdatepatientActivity extends Activity {
	...
	private UpdatepatientAdapter upadater;
	...
	private void init() {
		...
		pd_loging = new ProgressDialog(UpdatepatientActivity.this);
			...
			public void handleMessage(Message msg) {
				...
				if (msg.what == 0) {
					...
					Log.i("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
							"" + listItems.toString());
					upadater = new UpdatepatientAdapter(UpdatepatientActivity.this,
