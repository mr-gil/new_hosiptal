...
import com.sdu.edu.adapter.UpdateAdapter;
import com.sdu.edu.adapter.mergeAdapter;

import com.sdu.edu.callback.SizeCallBackForMenu;
import com.sdu.edu.control.Connectgetalldoctors;
...
public class MergeDoctorActivity extends Activity {
	// 第一个主界面
	private MenuHorizontalScrollView scrollView;
	private ListView menuList;
	private ListView doctorList;

	private mergeAdapter upadater;
	private List<String> listItems;
	private View up_doctorPage;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		this.up_doctorPage = inflater.inflate(R.layout.activity_update_doctor,
				null);
		this.title = (TextView) this.up_doctorPage
				.findViewById(R.id.topbar_title);
		title.setText("Delete Doctor");
		title.setGravity(Gravity.RIGHT);
		title.setTextSize(10.0f);
		this.menuBtn = (Button) this.up_doctorPage.findViewById(R.id.menuBtn);

		this.menuBtn.setOnClickListener(onClickListener);

		View leftView = new View(this);
		leftView.setBackgroundColor(Color.TRANSPARENT);
		final View[] children = new View[] { leftView, up_doctorPage };
	...
	private void init() {
		...
		pd_loging = new ProgressDialog(MergeDoctorActivity.this);
	...
	private class Adddoctor implements Runnable {
		public void run() {
			// 获得所有列表
			Connectgetalldoctors ctt = new Connectgetalldoctors("1");
			...
			public void handleMessage(Message msg) {
				...
				if (msg.what == 0) {
					...
					Log.i("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
							"" + listItems.toString());
					upadater = new mergeAdapter(MergeDoctorActivity.this,
							R.layout.all_doctor_list_item, listItems);
					doctorList = (ListView)up_doctorPage
							.findViewById(R.id.update_doctor_list);
					doctorList.setAdapter(upadater);
